...
btn_modo_nocturno.addEventListener(
  "click",
  function () {
    ...
    cambio(
      ...
      btn_crear_gifos,
      "assets/CTA-crar-gifo-modo-noc.svg"
    );
    cambio(
      srclogo,
      "assets/logo-mobile.svg",
      logo,
      "assets/logo-mobile-modo-noct.svg"
    );
    cambio(
      base,
      "assets/element-camara.svg",
      base_camara,
      "assets/camara-modo-noc.svg"
    );
  },
  false
);
